...
def test_carousel_swiper_viewport_bottom(browser):
    carousel = len(browser.find_elements(By.XPATH, '//div[@class="swiper-pagination carousel0 swiper-pagination-clickable swiper-pagination-bullets"]/*'))
    assert 11 == carousel

def test_carousel_swiper_viewport_top(browser):
    carousel = len(browser.find_elements(By.XPATH, '//div[@class="swiper-pagination slideshow0 swiper-pagination-clickable swiper-pagination-bullets"]/*'))
    assert 2 == carousel
